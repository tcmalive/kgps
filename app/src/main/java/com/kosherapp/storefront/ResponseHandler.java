...
public class ResponseHandler {
	...
	public static void purchaseResponse(final Context context,
		...
		new Thread(new Runnable() {
			public void run() {
				...
				int quantity = db.updatePurchase(orderId, productId, purchaseState,
	 ...
	 * errors and also for acknowledging that an order was sent successfully to the
	 * server. This is NOT used for any purchase state changes. All purchase state
	 * changes are received in the {@link BillingReceiver} and are handled in
	 ...
	 *         the context
	 * @param request
	 *         the RestoreTransactions request for which we received a response
	 *         code
	 * @param responseCode
	 *         a response code from Market to indicate the state of the request
	 */
